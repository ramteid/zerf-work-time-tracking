...
static LANGUAGES: &[LangDef] = &[
    LangDef {
        ...
        translations: &[
            ...
            ("absence_requested_body", "{requester_name} requested a {kind} absence from {start_date} to {end_date}."),
            ("absence_updated_title", "Absence request updated"),
            ("absence_updated_body", "{requester_name} updated their {kind} absence request ({start_date} to {end_date})."),
            ("absence_approved_title", "Absence approved"),
            ("absence_approved_body", "Your {kind} absence ({start_date} to {end_date}) has been approved."),
            ("absence_rejected_title", "Absence rejected"),
            ("absence_rejected_body", "Your {kind} absence ({start_date} to {end_date}) was rejected: {reason}"),
            ("absence_revoked_title", "Absence revoked"),
            ("absence_revoked_body", "Your {kind} absence ({start_date} to {end_date}) has been revoked by an administrator."),
            ("absence_cancelled_title", "Absence request withdrawn"),
            ("absence_cancelled_body", "{requester_name} withdrew their {kind} absence request ({start_date} to {end_date})."),
            ("absence_cancellation_requested_title", "Absence cancellation requested"),
            ("absence_cancellation_requested_body", "{requester_name} requested to cancel their {kind} absence ({start_date} to {end_date})."),
            ("absence_cancellation_approved_title", "Absence cancellation approved"),
            ("absence_cancellation_approved_body", "Your cancellation request for the {kind} absence ({start_date} to {end_date}) has been approved."),
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("absence_approved_body", "Ihre {kind} ({start_date} bis {end_date}) wurde genehmigt."),
            ("absence_rejected_title", "Abwesenheit abgelehnt"),
            ("absence_rejected_body", "Ihre {kind} ({start_date} bis {end_date}) wurde abgelehnt: {reason}"),
            ("absence_revoked_title", "Abwesenheit widerrufen"),
            ("absence_revoked_body", "Ihre {kind} ({start_date} bis {end_date}) wurde von einem Administrator widerrufen."),
