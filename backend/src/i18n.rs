...
static LANGUAGES: &[LangDef] = &[
    LangDef {
        ...
        translations: &[
            ...
            ("reopen_request_created_body", "{requester_name} requested to reopen week {week_label}."),
            ("reopen_request_created_body_changes", "{requester_name} requested to reopen week {week_label}.\n\nOpen change requests:\n{change_request_overview}"),
            ("reopen_approved_title", "Week reopen approved"),
            ("reopen_approved_body", "Your week reopen request was approved.\n\nWeek: {week_label}"),
            ("reopen_approved_body_changes", "Your week reopen request was approved.\n\nWeek: {week_label}\n\nChange requests in this week were applied:\n{change_request_overview}"),
            ...
            ("reopen_approved_by_admin_body_changes", "The week reopen request from {requester_name} was approved by an admin.\n\nWeek: {week_label}\n\nChange requests in this week were applied:\n{change_request_overview}"),
            ...
            ("absence_auto_approved_notice_title", "Sick leave recorded"),
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("reopen_request_created_body", "{requester_name} m\u{00f6}chte Woche {week_label} wieder bearbeiten."),
            ("reopen_request_created_body_changes", "{requester_name} m\u{00f6}chte Woche {week_label} wieder bearbeiten.\n\nOffene \u{00c4}nderungsantr\u{00e4}ge:\n{change_request_overview}"),
            ("reopen_approved_title", "Wochenfreigabe genehmigt"),
            ("reopen_approved_body", "Ihre Anfrage zur Wochenfreigabe wurde genehmigt.\n\nWoche: {week_label}"),
            ("reopen_approved_body_changes", "Ihre Anfrage zur Wochenfreigabe wurde genehmigt.\n\nWoche: {week_label}\n\n\u{00c4}nderungsantr\u{00e4}ge dieser Woche wurden \u{00fc}bernommen:\n{change_request_overview}"),
            ...
            ("reopen_approved_by_admin_body_changes", "Die Wiederfreigabe-Anfrage von {requester_name} wurde von einem Admin genehmigt.\n\nWoche: {week_label}\n\n\u{00c4}nderungsantr\u{00e4}ge dieser Woche wurden \u{00fc}bernommen:\n{change_request_overview}"),
            ...
            ("absence_auto_approved_notice_title", "Krankmeldung erfasst"),
