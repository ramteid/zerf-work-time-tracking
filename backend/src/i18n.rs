...
static LANGUAGES: &[LangDef] = &[
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("absence_cancellation_requested_title", "Stornierungsanfrage für Abwesenheit"),
            ("absence_cancellation_requested_body", "{requester_name} möchte die Abwesenheit ({start_date} bis {end_date}) stornieren."),
