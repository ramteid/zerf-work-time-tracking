...
static LANGUAGES: &[LangDef] = &[
    LangDef {
        ...
        translations: &[
            ...
            ("timesheet_batch_rejected_body", "Your timesheets were rejected.\n\nScope: {week_count}\nReason: {reason}\n\nPlease update your entries and submit the affected weeks again."),
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("absence_auto_approved_notice_body", "Die Abwesenheit vom Typ {kind} von {requester_name} wurde automatisch genehmigt.\n\nZeitraum: {start_date} bis {end_date}\n\nDiese Nachricht dient nur der Information."),
            ...
            ("timesheet_batch_rejected_body", "Ihre Zeiterfassungen wurden abgelehnt.\n\nUmfang: {week_count}\nGrund: {reason}\n\nBitte passen Sie Ihre Eintr\u{00e4}ge an und reichen Sie die betroffenen Wochen erneut ein."),
